  ...
  <div class="col-xl-12">
    <div class="card shadow">
      <div class="card-header">
        <h4 class="text-center">ข้อมูลประเทศ</h4>
      </div>
      <div class="card-body">
        <div class="row justify-content-end mb-2">
          ...
          <div class="col-xl-3 mb-2">
            <a href="/country/export" class="btn btn-success btn-sm btn-block">
              <i class="fas fa-download pr-2"></i>นำข้อมูลออก
            </a>
          </div>
          <div class="col-xl-3 mb-2">
            <a href="/country/create" class="btn btn-primary btn-sm btn-block">
              ...
              <table class="table table-bordered table-hover data">
                <thead>
                  <tr>
                    ...
                    <th width="30%">รายชื่อ (TH)</th>
                    <th width="30%">รายชื่อ (EN)</th>
                  </tr>
                </thead>
              </table>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <form action="/country/import" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="row mb-2">

...
$row = $CUSTOMER->customer_type_view([$uuid]);
...
<div class="row">
  <div class="col-xl-12">
    <div class="card shadow">
      ...
      <div class="card-body">
        <form action="/customer-type/edit" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          ...
          <div class="row mb-2">
            ...
            <div class="col-xl-6">
              <textarea class="form-control form-control-sm" name="name" rows="3" required><?php echo $name ?></textarea>
          ...
          <div class="row justify-content-center mb-2">
            ...
            <div class="col-xl-3 mb-2">
              <a href="/customer-type" class="btn btn-sm btn-danger btn-block">
